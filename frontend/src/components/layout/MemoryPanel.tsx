  ...
  return (
    ...
    >
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
        ...
        <div style={{
          width: 28, height: 2,
          background: 'var(--lv-rule)', borderRadius: 0, overflow: 'hidden', flexShrink: 0,
        }}>
          <div style={{
            width: `${Math.round(record.importance * 100)}%`,
            height: '100%',
            background: 'var(--lv-gold)', opacity: 0.6,
          }} />
        </div>
        <button
      ...
      {/* Content */}
      <p style={{
        fontFamily: 'var(--font-sans)', fontSize: 12.5, color: 'var(--lv-soft)',
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
      ...
      {records.length === 0 && !loading && (
        <p style={{
          fontFamily: 'var(--font-mono)', fontSize: 11, color: 'var(--lv-mute)',
          textAlign: 'center', paddingTop: 24, lineHeight: 1.8,
        }}>
          No memories yet.<br />
          Memories form automatically<br />as conversations compress.
        </p>
      )}
